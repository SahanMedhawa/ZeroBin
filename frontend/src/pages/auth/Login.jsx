...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (
        emailCheck.exists &&
        emailCheck.authMethod === "google" &&
        !emailCheck.hasPasswordAuth
      ) {
        setError(
          "This account uses Google Sign-In. Please click 'Continue with Google' below to login."
        );
        return;
      }
                ...
                <form className="space-y-5" onSubmit={handleCollectorLogin}>
                  ...
                  <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl">
                    <p className="text-sm text-gray-700">
                      <strong>Note:</strong> Contact your WMA administrator if
                      you need assistance.
                    </p>
                  </div>
                </form>
