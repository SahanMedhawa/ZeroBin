...
const WMADrawer = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-br from-purple-700 to-indigo-800 text-white shadow-2xl transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-6 border-b border-purple-600">
          <Link to="/wma/dashboard" className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-purple-300">Fleet Manager Portal</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-purple-600">
          ...
          >
            <svg
              className="w-5 h-5 group-hover:text-red-300 transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
