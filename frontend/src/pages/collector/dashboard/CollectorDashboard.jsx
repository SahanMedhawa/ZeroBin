        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white p-6 rounded-xl shadow-lg transition-colors flex items-center justify-center space-x-3"
            >
              ...
              <div className="space-y-4">
                {progressSchedules.map((schedule) => {
                  ...
                  return (
                    <div
                      key={schedule._id}
                      className="border border-gray-200 rounded-lg p-4 flex items-center justify-between hover:border-green-500 transition-colors"
                    >
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
            <p className="text-green-100 text-sm mb-2">Monthly Earning so far</p>
            <h3 className="text-4xl font-bold mb-4">Rs. 15,000.00</h3>
            <button
              onClick={() => navigate('/collector/earnings')}
              className="bg-white text-green-600 hover:bg-green-50 px-6 py-3 rounded-lg font-semibold transition-colors"
            >
              View More Details
            </button>
          </div>
